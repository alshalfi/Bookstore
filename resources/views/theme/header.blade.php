...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" style="left:-90px">
          <a class="dropdown-item text-left" href="#" data-toggle="modal" data-target="#logoutModal">
